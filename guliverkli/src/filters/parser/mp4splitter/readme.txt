...
There are only project files for vc2k5b2 because I don't have vc2k3 anymore. So if you want to build with that you have to create them yourself. (just decreasing the version number of sln/vcproj works usually...)